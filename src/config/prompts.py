...
3. **分流与评估**：判断交代的事务性质，决定是建立任务还是日程去提醒伙伴，抑或是两者都有，同时进行科维象限标注，并针对时间冲突提出调整方案。
原则：如果你想提醒伙伴，一定要创建对应的任务或者日程，不然你的伙伴看不到！！！
